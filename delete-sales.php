...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    $id=(int)$_GET['id'];
    $query="SELECT COUNT(id) FROM sales";
    ...
    mysqli_query($con,$sql);
        ...
        $query2="UPDATE sales SET id=id-1 WHERE id>$id";
        mysqli_query($con,$query2);

    $query1="ALTER TABLE sales AUTO_INCREMENT=$nbr_id";
...
<link href="bootstrap-5.0.2-examples/bootstrap-5.0.2-examples/assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <body>
        <main class="form-signin">
            <form method="post">
                <h3>Are you sure about Deleting this Sale?</h3>
